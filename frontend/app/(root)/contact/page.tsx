...
const ContactPage = () => {
  ...
  return (
    <div className="container mx-auto md:px-4 px-1 md:py-20 py-10 max-w-2xl">
      <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4 text-sky-400">Contact</h2>

      <div className="bg-white dark:bg-slate-800 rounded-lg md:p-6 p-2 shadow-md space-y-6">
